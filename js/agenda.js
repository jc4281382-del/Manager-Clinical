...
async function loadAgenda() {
    ...
    // A Agenda vai listar os agendamentos do dia, ordenados.
    // Vamos usar a mesma lógica do dashboard pra buscar
    ...
    // Horários padrão de exemplo (08:00 às 18:00)
                    ...
                    <div class="flex-1">
                        <div class="bg-white p-4 rounded-xl border border-[#EEF2F5] shadow-sm flex justify-between items-center hover:shadow-md transition-shadow relative overflow-hidden \${app.status === 'Cancelado' ? 'opacity-50' : ''}">
                            ...
                            <div class="text-right">
                                ...
                                <button class="mt-2 text-primary" onclick="window.openAppointmentModal()">
